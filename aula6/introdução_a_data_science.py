...
print("Notas media do Toy Story %.2f" % notas_do_toy_story.nota.mean())
print("Notas media do Jumanji %.2f" % notas_do_jumanji.nota.mean())

print("Notas mediana do Toy Story %.2f" % notas_do_toy_story.nota.median())
print("Notas mediana do Jumanji %.2f" % notas_do_jumanji.nota.median())
...
print("Desvio padrao do Toy Story %.2f " % notas_do_jumanji.nota.std())
print("Desvio padrao do Jumanji %.2f " % notas_do_toy_story.nota.std())